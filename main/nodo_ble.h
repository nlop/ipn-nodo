...
static uint8_t service_uuid[16] = {
    ...
    0xfb, 0x34, 0x9b, 0x5f, 0x80, 0x00, 0x00, 0x80, 0x00, 0x10, 0x00, 0x00, 0xF1, 0x00, 0x00, 0x00,
};
static const uint16_t primary_service_uuid = ESP_GATT_UUID_PRI_SERVICE;
/* Valores asignados por Bluetooth SIG */
static const uint16_t temperature_uuid = 0x2A6E;
static const uint16_t humidity_uuid = 0x2B18; // Volts
//static const uint16_t humidity_uuid= 0x2A6F; % de humedad
...
static const uint8_t temperature_ccc[2] = {0x00, 0x00};
...
static const esp_gatts_attr_db_t gatt_db[DB_LEN] =  {
    ...
    {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&character_client_config_uuid, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE,
      sizeof(uint16_t), sizeof(temperature_ccc), (uint8_t *)temperature_ccc}},
    [ID_CHAR_HUM] =
        {{ESP_GATT_AUTO_RSP},
            {
                ESP_UUID_LEN_16,
